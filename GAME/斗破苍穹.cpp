...
break;
case 6:
printf(" 您好，欢迎您玩苍穹世界。为了给您更好的游戏体验，本团队时不时会优化本游戏，优化后会尽快发布在网上。关于外挂方面，开启外挂的方式是设定勇者姓名时，输入“圣战斗士 ”（不包括双引号）。由于2.0版本的bug，我们在2.0的基础上进行修改，已修复该bug。并且新增了经验草等有助于升级的道具，希望大家喜欢。在这里要感谢离陌同学，他给了我们许多宝贵的建议，谢谢。\n");
break;
case 0:
printf("确定退出游戏?(Y/N)\n\n\n");
getchar();
